...
As I share each source, evaluate it:
- **What's useful**: Key quotes, data points, timeline events
- **Quality tier**: Is this a primary source (T1), partial/excerpted (T2), or just a reference (T3)?
- **What's missing**: What additional sources would strengthen the case?

After reviewing all sources, give me an honest assessment:
- Overall readiness score (1-5) for depth, breadth, reliability, completeness
- Specific gaps to fill before writing
- Whether we should gather more sources or proceed
...
After completing each document, check:
- All quotes traced to dated sources I provided
- All numbers verified against my source documents
- No claims based on your general knowledge that I haven't sourced
