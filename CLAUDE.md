...
`/setup-case` · `/add-sources` · `/assess-sources` · `/write-document` · `/check-status` · `/verify-all` · `/verify-consistency` · `/verify-quotes` · `/verify-sources` · `/verify-links` · `/validate-financials` · `/assess-bias` · `/verify-cross-document` · `/add-disclaimers` · `/export-pdf` · `/git-update`
